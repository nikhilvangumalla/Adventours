...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmlraGlsLXZhbmd1bWFsbGEiLCJhIjoiY2sycWRxaGM0MDNscjNsbGxpYnZqenQ4NSJ9.Fqz4aizVo2AykGbxDFynzA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nikhil-vangumalla/ck2qdydsz1qak1crovmg17cqe',
    scrollZoom: false,
    doubleClickZoom: false // dragPan: true
...
},{}],"loginAndLogout.js":[function(require,module,exports) {
"use strict";
  ...
  return regeneratorRuntime.async(function login$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          document.cookie = "jwt=".concat(res.data.token, ";expries=").concat(new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toGMTString()); // console.log(res);

          if (res.data.status === 'success') {
            // if u want delay after pressing submit button use below code
            (0, _alerts.showAlert)('success', 'Logged in successfully'); // window.setTimeout(() => {
            //   location.assign('/');
            // }, 2000);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          document.cookie = "jwt=;expires= ".concat(new Date(Date.now()));
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'Error Logging Out! Please try again'); // location.assign('/');
          // location.reload(true);
...
var stripe = Stripe('pk_test_Tw9oe8toub35bZZd3kUi6np600oqjE0V5G');
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _loginAndLogout.login)(email, password);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14697" + '/');
